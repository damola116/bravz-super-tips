...
class DailytipsTable extends SupabaseTable<DailytipsRow> {
  @override
  String get tableName => 'dailytips';

  @override
  DailytipsRow createRow(Map<String, dynamic> data) => DailytipsRow(data);
}

class DailytipsRow extends SupabaseDataRow {
  DailytipsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DailytipsTable();
