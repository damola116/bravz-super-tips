...
class OldhistoryTable extends SupabaseTable<OldhistoryRow> {
  @override
  String get tableName => 'oldhistory';

  @override
  OldhistoryRow createRow(Map<String, dynamic> data) => OldhistoryRow(data);
}

class OldhistoryRow extends SupabaseDataRow {
  OldhistoryRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => OldhistoryTable();
