...
class MaxbetTable extends SupabaseTable<MaxbetRow> {
  @override
  String get tableName => 'maxbet';

  @override
  MaxbetRow createRow(Map<String, dynamic> data) => MaxbetRow(data);
}

class MaxbetRow extends SupabaseDataRow {
  MaxbetRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MaxbetTable();
