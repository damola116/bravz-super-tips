...
class BasketballTable extends SupabaseTable<BasketballRow> {
  @override
  String get tableName => 'basketball';

  @override
  BasketballRow createRow(Map<String, dynamic> data) => BasketballRow(data);
}

class BasketballRow extends SupabaseDataRow {
  BasketballRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BasketballTable();
