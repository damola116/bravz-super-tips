...
class DrawFtTable extends SupabaseTable<DrawFtRow> {
  @override
  String get tableName => 'draw ft';

  @override
  DrawFtRow createRow(Map<String, dynamic> data) => DrawFtRow(data);
}

class DrawFtRow extends SupabaseDataRow {
  DrawFtRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DrawFtTable();
