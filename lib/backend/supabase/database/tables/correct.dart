...
class CorrectTable extends SupabaseTable<CorrectRow> {
  @override
  String get tableName => 'correct';

  @override
  CorrectRow createRow(Map<String, dynamic> data) => CorrectRow(data);
}

class CorrectRow extends SupabaseDataRow {
  CorrectRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CorrectTable();
