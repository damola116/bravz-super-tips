...
class BetofthedayTable extends SupabaseTable<BetofthedayRow> {
  @override
  String get tableName => 'betoftheday';

  @override
  BetofthedayRow createRow(Map<String, dynamic> data) => BetofthedayRow(data);
}

class BetofthedayRow extends SupabaseDataRow {
  BetofthedayRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BetofthedayTable();
