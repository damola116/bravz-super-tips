...
class _DiamondWidgetState extends State<DiamondWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiamondModel());
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Get all the features at a discount for three months membership.',
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await revenue_cat.purchasePackage(revenue_cat
                                ...
                                .threeMonth!
                                .identifier);
                            if (_model.didpurchase1!) {
                              context.pushNamed('listdiamond');
                            } else {
