  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case BetofthedayRow:
            return BetofthedayRow(data);
          case Winner1Row:
            return Winner1Row(data);
          case Winner4Row:
            return Winner4Row(data);
          case WinnerRow:
            return WinnerRow(data);
          case HistoryRow:
            return HistoryRow(data);
          case HalfXDrawRow:
            return HalfXDrawRow(data);
          case MaxbetRow:
            return MaxbetRow(data);
          case CorrectRow:
            return CorrectRow(data);
          case BasketballRow:
            return BasketballRow(data);
          case Winner2Row:
            return Winner2Row(data);
          case DailytipsRow:
            return DailytipsRow(data);
          case DrawFtRow:
            return DrawFtRow(data);
          case OldhistoryRow:
            return OldhistoryRow(data);
          case Winner3Row:
            return Winner3Row(data);
          default:
            return null;
        }
